        ...
        <div className="card-body">
          <div className="d-flex justify-content-between">
            <div className="d-flex flex-row align-items-center">
              <div>
                <img src={`https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-shopping-carts/img${item.id}.webp`} className="img-fluid rounded-3" alt="Shopping item" style={{ width: "65px" }} />
              </div>
              <div className="ms-3">
                <h5>{item.name}</h5>
            ...
            <div style={{ width: "50px" }}>
                <h5 className="fw-normal mb-0">
                  <button onClick={() => decreaseQuantity(item.id)} className="btn btn-danger btn-sm">-</button>
                </h5>
              </div>
            <div style={{ width: "50px" }}>
                <h5 className="fw-normal mb-0">
                  <button onClick={() => increaseQuantity(item.id)} className="btn btn-primary btn-sm">+</button>
                </h5>
              </div>
              <div style={{ width: "80px" }}>
                <h5 className="mb-0">${item.price * item.quantity}</h5>
              </div>
              <a href="#!" style={{ color: "#cecece" }} onClick={() => removeItem(item.id)}><i className="fas fa-trash-alt"></i></a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="card bg-primary text-white rounded-3">
                    <div className="card-body">
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="btn btn-info btn-block">Checkout</button>
                      </form>
